...
// pour être réutilisé À L'IDENTIQUE par toute autre voie d'acquisition future (ex. transfert réseau sur
// la branche feature/reseau-local). Sans ce partage, un objet reçu autrement que par le bouton
// "Posséder" de la modale marquerait bien objetsMagiquesPossedes à jour, mais n'apparaîtrait nulle part
// sur la fiche (aucune arme/armure synthétisée).
