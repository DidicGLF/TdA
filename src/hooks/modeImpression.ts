...
// Vrai uniquement dans le conteneur hors écran capturé pour l'export PDF des fiches compagnons (voir
// App.tsx/exportCompagnonsPdf.ts) — jamais vrai dans la fiche éditable normale. Sert à masquer les affordances
